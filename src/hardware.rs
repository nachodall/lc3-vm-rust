use libc::{
    ECHO, FD_SET, FD_ZERO, ICANON, STDIN_FILENO, TCSANOW, VMIN, VTIME, tcgetattr, tcsetattr,
    termios,
};
...
/// Configures the terminal for "raw" input by disabling line buffering and echoing.
...
pub fn check_key() -> bool {
    unsafe {
        ...
        FD_ZERO(&mut readfds);
        // Set the bit for STDIN (the keyboard)
